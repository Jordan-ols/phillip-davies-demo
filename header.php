...
<html>
    <head>
        ...
        <title>Philip Davies demo</title>
        <?php wp_head(); ?>
        <style>
            html {
    ...
    <body>
        <a class="skip-link screen-reader-text" href="#content"><?php _e( 'Skip to content', 'Philip-davies-demo' ); ?></a>
            ...
            <header class="pd-site-header">
                ...
                <div class="site-title">
                    <h1 class="display-1 font-weight-bolder">Philip Davies</h1>
                    <h2 class="strapline display-4 font-weight-bold">Scriptwriter</h2>
                </div>
