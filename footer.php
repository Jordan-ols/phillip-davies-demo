        ...
        <footer class="site-footer-test">
            <div class="container">
                ...
                <div class="something-different" style="background-image:url('<?php echo PD_IMG_URI . 'sd-background.png'?>');">
                    <h5 class="mt-4 text-center text-light">Something a little…different<img src="<?php echo PD_IMG_URI . 'group-38.svg' ?>" class="sd-arrow" alt="Something different arrow"/></h5>
                </div>
            </div>
        </footer>
    </body>
